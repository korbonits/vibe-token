...
async function main() {
  ...
  console.log(`Minting ${ethers.formatUnits(AMOUNT, 18)} VIBE to ${signer.address}...`);
  ...
  console.log("Balance:            ", ethers.formatUnits(await token.balanceOf(signer.address), 18), "VIBE");
}
